...
(() => {
    ...
    /* 패널 열릴 때 본문을 오른쪽으로만 밀기 (폰트/레이아웃은 건들지 말기) */
    html.bj-helper-open body {
      padding-right: var(--bj-panel-width);
    ...
    @media (max-width: 800px) {
      ...
      html.bj-helper-open body { padding-right: 0; }
      #bj-helper-panel {
    ...
    /* 우리 패널 안에서만 Tailwind / DaisyUI 같은 전역 table 스타일 쓰게 하고,
       백준 원래 테이블은 폰트 다시 키우기 */
    body table,
    body table td,
    body table th {
      font-size: 15px !important;      /* 필요하면 13px / 14px 로 바꿔도 됨 */
      line-height: 1.5 !important;
    }

    /* 우리 패널 내부는 그대로(알고트랙용 table은 영향 X) */
    #bj-helper-panel table,
    #bj-helper-panel td,
    #bj-helper-panel th {
  ...
  `;
    ...
    // ===========================================================
    // 6-3) 문제 페이지에서 알고리즘명 파싱해서 저장 (배열로)
    // ===========================================================
